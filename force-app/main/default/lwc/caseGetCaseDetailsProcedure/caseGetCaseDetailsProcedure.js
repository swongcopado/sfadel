...
import { OMNIDEF } from './caseGetCaseDetailsProcedure_def.js';
import tmpl from './caseGetCaseDetailsProcedure.html';
import tmpl_nds from './caseGetCaseDetailsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseGetCaseDetailsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
