...
import { OMNIDEF } from './violationFeeCalculatorProcedure_def.js';
import tmpl from './violationFeeCalculatorProcedure.html';
import tmpl_nds from './violationFeeCalculatorProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class violationFeeCalculatorProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
