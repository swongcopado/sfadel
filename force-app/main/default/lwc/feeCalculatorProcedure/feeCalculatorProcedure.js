...
import { OMNIDEF } from './feeCalculatorProcedure_def.js';
import tmpl from './feeCalculatorProcedure.html';
import tmpl_nds from './feeCalculatorProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class feeCalculatorProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
