...
import { OMNIDEF } from './documentServiceGatewayDocGenerationProcedure_def.js';
import tmpl from './documentServiceGatewayDocGenerationProcedure.html';
import tmpl_nds from './documentServiceGatewayDocGenerationProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentServiceGatewayDocGenerationProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
