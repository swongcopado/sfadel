(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.ProgressBar = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    var Circle = function Circle(lwcontainer, options) {
    ...
    var Line = function Line(lwcontainer, options) {
    ...
    var SemiCircle = function SemiCircle(lwcontainer, options) {
    ...
    SemiCircle.prototype._initializeTextlwcontainer = function _initializeTextlwcontainer(
        opts,
        lwcontainer,
        textlwcontainer
    ) {
        if (opts.text.style) {
            // Reset top style
            textlwcontainer.style.top = 'auto';
            textlwcontainer.style.bottom = '0';
    
            if (opts.text.alignToBottom) {
                utils.setStyle(textlwcontainer, 'transform', 'translate(-50%, 0)');
            } else {
                utils.setStyle(textlwcontainer, 'transform', 'translate(-50%, 50%)');
            }
        }
    };
    ...
    var Shape = function Shape(lwcontainer, opts) {
        ...
        var element;
        if (utils.isString(lwcontainer)) {
            element = document.querySelector(lwcontainer);
        } else {
            element = lwcontainer;
        }
    
        if (!element) {
            throw new Error('lwcontainer does not exist: ' + lwcontainer);
        }
    
        this._lwcontainer = element;
        this._lwcontainer.appendChild(svgView.svg);
        if (this._opts.warnings) {
            this._warnlwcontainerAspectRatio(this._lwcontainer);
        }
    ...
    Shape.prototype.setText = function setText(newText) {
        ...
        if (this.text === null) {
            ...
            this.text = this._createTextlwcontainer(this._opts, this._lwcontainer);
            this._lwcontainer.appendChild(this.text);
        }
    ...
    Shape.prototype._createTextlwcontainer = function _createTextlwcontainer(opts, lwcontainer) {
        var textlwcontainer = document.createElement('div');
        textlwcontainer.className = opts.text.className;
    
        var textStyle = opts.text.style;
        if (textStyle) {
            if (opts.text.autoStylelwcontainer) {
                lwcontainer.style.position = 'relative';
            }
    
            utils.setStyles(textlwcontainer, textStyle);
            // Default text color to progress bar's color
            if (!textStyle.color) {
                textlwcontainer.style.color = opts.color;
            }
        }
    
        this._initializeTextlwcontainer(opts, lwcontainer, textlwcontainer);
        return textlwcontainer;
    };
    
    // Give custom shapes possibility to modify text element
    Shape.prototype._initializeTextlwcontainer = function(opts, lwcontainer, element) {
        // By default, no-op
    ...
    Shape.prototype._warnlwcontainerAspectRatio = function _warnlwcontainerAspectRatio(lwcontainer) {
        if (!this.lwcontainerAspectRatio) {
            return;
        }
    
        var computedStyle = window.getComputedStyle(lwcontainer, null);
        var width = parseFloat(computedStyle.getPropertyValue('width'), 10);
        var height = parseFloat(computedStyle.getPropertyValue('height'), 10);
        if (!utils.floatEquals(this.lwcontainerAspectRatio, width / height)) {
            console.warn(
                'Incorrect aspect ratio of lwcontainer',
                '#' + lwcontainer.id,
                'detected:',
    ...
    var Square = function Square(lwcontainer, options) {
        this._pathTemplate =
