...
import { OMNIDEF } from './accountAlertNotificationsProcedure_def.js';
import tmpl from './accountAlertNotificationsProcedure.html';
import tmpl_nds from './accountAlertNotificationsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountAlertNotificationsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
