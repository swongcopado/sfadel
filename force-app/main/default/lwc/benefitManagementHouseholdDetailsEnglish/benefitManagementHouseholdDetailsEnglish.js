...
import { OMNIDEF } from './benefitManagementHouseholdDetailsEnglish_def.js';
import tmpl from './benefitManagementHouseholdDetailsEnglish.html';
import tmpl_nds from './benefitManagementHouseholdDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class benefitManagementHouseholdDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
