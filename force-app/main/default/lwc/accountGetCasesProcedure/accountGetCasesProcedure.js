...
import { OMNIDEF } from './accountGetCasesProcedure_def.js';
import tmpl from './accountGetCasesProcedure.html';
import tmpl_nds from './accountGetCasesProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountGetCasesProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
