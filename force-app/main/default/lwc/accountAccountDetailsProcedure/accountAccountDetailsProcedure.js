...
import { OMNIDEF } from './accountAccountDetailsProcedure_def.js';
import tmpl from './accountAccountDetailsProcedure.html';
import tmpl_nds from './accountAccountDetailsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountAccountDetailsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
