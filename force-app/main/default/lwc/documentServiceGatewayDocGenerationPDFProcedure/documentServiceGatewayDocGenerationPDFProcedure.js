...
import { OMNIDEF } from './documentServiceGatewayDocGenerationPDFProcedure_def.js';
import tmpl from './documentServiceGatewayDocGenerationPDFProcedure.html';
import tmpl_nds from './documentServiceGatewayDocGenerationPDFProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentServiceGatewayDocGenerationPDFProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
