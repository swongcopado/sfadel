...
import { OMNIDEF } from './publicComplaintSearchProcedure_def.js';
import tmpl from './publicComplaintSearchProcedure.html';
import tmpl_nds from './publicComplaintSearchProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class publicComplaintSearchProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
