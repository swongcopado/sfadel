...
import { OMNIDEF } from './caseGetCaseCommentsProcedure_def.js';
import tmpl from './caseGetCaseCommentsProcedure.html';
import tmpl_nds from './caseGetCaseCommentsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class caseGetCaseCommentsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
