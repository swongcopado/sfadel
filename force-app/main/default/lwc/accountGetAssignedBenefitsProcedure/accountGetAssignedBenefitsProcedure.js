...
import { OMNIDEF } from './accountGetAssignedBenefitsProcedure_def.js';
import tmpl from './accountGetAssignedBenefitsProcedure.html';
import tmpl_nds from './accountGetAssignedBenefitsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountGetAssignedBenefitsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
