...
import { OMNIDEF } from './licenseSearchProcedure_def.js';
import tmpl from './licenseSearchProcedure.html';
import tmpl_nds from './licenseSearchProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class licenseSearchProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
