...
import { OMNIDEF } from './accountGetContactsProcedure_def.js';
import tmpl from './accountGetContactsProcedure.html';
import tmpl_nds from './accountGetContactsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountGetContactsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
