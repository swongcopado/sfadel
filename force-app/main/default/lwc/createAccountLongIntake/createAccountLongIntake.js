...
export default class CreateAccountLongIntake extends OmniscriptBaseMixin(LightningElement) {
    accountId;

    createAccountRecord(event){
        console.log("createAccountRecord: createAccountLongIntake: " + JSON.stringify(event.detail.fields));
