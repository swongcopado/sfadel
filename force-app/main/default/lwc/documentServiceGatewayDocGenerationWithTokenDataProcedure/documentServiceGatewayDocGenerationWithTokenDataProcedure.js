...
import { OMNIDEF } from './documentServiceGatewayDocGenerationWithTokenDataProcedure_def.js';
import tmpl from './documentServiceGatewayDocGenerationWithTokenDataProcedure.html';
import tmpl_nds from './documentServiceGatewayDocGenerationWithTokenDataProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentServiceGatewayDocGenerationWithTokenDataProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
