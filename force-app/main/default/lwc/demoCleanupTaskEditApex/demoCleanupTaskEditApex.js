//  Javascript controller for the edit Apex Cleanup Task modal for the Demo Cleanup Lightning component.
//
...
export default class DemoCleanupTaskEditApex extends NavigationMixin(LightningElement) {
	@api recordId;
	...
	@wire(getRecord, {
		recordId: '$recordId',
		fields: [DESCRIPTION_FIELD, APEX_CLASS_NAME_FIELD, PERMANENTLY_DELETE_FIELD, ACTIVE_FIELD]
	})
	wired_getRecord({ data, error }) {
		if (data) {
			...
			this.apexClassName = getFieldValue(data, APEX_CLASS_NAME_FIELD);
