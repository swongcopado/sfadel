...
import { OMNIDEF } from './accountCountObjectRecordsProcedure_def.js';
import tmpl from './accountCountObjectRecordsProcedure.html';
import tmpl_nds from './accountCountObjectRecordsProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountCountObjectRecordsProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
