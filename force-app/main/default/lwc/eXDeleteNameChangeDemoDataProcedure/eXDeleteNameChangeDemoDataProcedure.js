...
import { OMNIDEF } from './eXDeleteNameChangeDemoDataProcedure_def.js';
import tmpl from './eXDeleteNameChangeDemoDataProcedure.html';
import tmpl_nds from './eXDeleteNameChangeDemoDataProcedure_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eXDeleteNameChangeDemoDataProcedure extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
